...
public class ReusingPojoByDataprovider {
	@BeforeClass
	public void before() {
	...
	public void test(String name,String type,String desc) {
  ...
  public Object[] getData() {
	  return new Object[][] {
		  {"workspace1","personal","desption1"},
		  {"workspace2","team","desption2"}
	  };
  }
